...
automail reconfiguration. ADR-0135 exposes the base transition claim examples
through direct text and JSON CLI validation. ADR-0140 carries the base
...
reconfiguration claim, automail reconfiguration, to predicate-result. ADR-0134
exposes the transition proof-certificate surface through direct text and JSON
CLI validation.
